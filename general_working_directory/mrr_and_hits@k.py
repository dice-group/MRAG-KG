...
with open('evalaluation_results_2nd_retrieval_method_KG2_20_20.json', 'r') as file:
    data = json.load(file)
...
with open('evalaluation_results_2nd_retrieval_method_KG3_20_20.json', 'r') as file:
    data = json.load(file)
...
with open('evalaluation_results_2nd_retrieval_method_KG2_10_10.json', 'r') as file:
    data = json.load(file)
...
with open('evalaluation_results_2nd_retrieval_method_KG3_10_10.json', 'r') as file:
    data = json.load(file)
...
with open('evalaluation_results_2nd_retrieval_method_KG2_5_5.json', 'r') as file:
    data = json.load(file)
...
with open('evalaluation_results_2nd_retrieval_method_KG3_5_5.json', 'r') as file:
    data = json.load(file)
